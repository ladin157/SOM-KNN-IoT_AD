...
class KohonenSom(object):
    """
    This class provides an implementation of the Kohonen som-notebooks algorithm.
    ...
    def __init__(
        ...
        """ Initialization of the som-notebooks
    ...
    def fit(self, training_sample, num_iterations):
        """Train the som-notebooks to a specific dataset.
